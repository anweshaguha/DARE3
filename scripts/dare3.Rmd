...
modelsummary(mod2,
             ...
             gof_omit= "Adj|Pseudo|Log|Within|AIC|BIC|FE|Std|R2|F|Int",
             coef_rename = c("fit_read180_attend" = "READ180 attendace", "read180_attend" = "READ180 attendace", "dorf" = "Prestest Score", "frpl" = "Eligible for free lunch", "female" = "Female", "treat" = "Random Offer to READ180"),
             add_rows = row2,
             threeparttable= T,
