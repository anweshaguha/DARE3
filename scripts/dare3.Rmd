...
In this table, there is likely to be endogenous differences in the expected outcomes between children who attended after-school program at a high rate and those attended at a lower rate. The OLS estimate of the predictor read180_attend is likely to be correlated with the residuals in the outcome test score sat10_compreh. As a result, a causal interpretation would be premature just using this table and analysis.
